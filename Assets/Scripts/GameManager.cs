...
public class GameManager : MonoBehaviour
{
    ...
    //BGM
    public AudioClip BGM { get { return bgm; } set { bgm = value; } }
    ...
    private void Start()
    {
        driverList.Add(new Driver(1, "P1", 1, false, AIDifficult.normal, InputType.keyboard, 0));
    }
    ...
    public void OnRaceCompleted()
    {
        ...
        if (numberOfCarsRaceComplete >= map.MaxCars)
            OnRaceOver();
        else 
    ...
    //Driver
    public void AddDriverToList(int playerNumber, string name, int carID, bool isAI, AIDifficult difficult, InputType inputType, ulong networkId)
    {
        driverList.Add(new Driver(playerNumber, name, carID, isAI, difficult, inputType, networkId));
    }
