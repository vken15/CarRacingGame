...
{
    [SerializeField]
    private string m_InGameSceneName = "MultiplayerMapTest";
    ...
    public override void OnNetworkSpawn()
    {
        ...
        if (IsServer)
        {
            ...
            m_ClientsInLobby[NetworkManager.LocalClientId] = true;
    ...
    public void CheckForAllPlayersReady()
    {
        if (m_AllPlayersInLobby)
        {
            ...
            if (allPlayersAreReady)
            {
                ...
                int i = 0;
                foreach (var id in m_ClientsInLobby)
                {
                    i++;
                    GameManager.instance.AddDriverToList(i, "Test" + i, 1, false, AIDifficult.easy, InputType.keyboard, id.Key);
                }
